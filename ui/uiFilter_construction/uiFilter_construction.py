...
class Ui_filterWindow(object):
    ...
    def retranslateUi(self, filterWindow):
        ...
        self.filterNameBox.setItemText(0, QCoreApplication.translate("filterWindow", u"ramp", None))
        ...
        self.filterNameBox.setItemText(4, QCoreApplication.translate("filterWindow", u"hann", None))

        self.filterNameBox.setCurrentText(QCoreApplication.translate("filterWindow", u"ramp", None))
